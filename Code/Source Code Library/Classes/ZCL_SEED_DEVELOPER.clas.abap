...
CLASS zcl_seed_developer IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    INSERT zdeveloper FROM TABLE @( VALUE #(
      ( developer_id = 'DEV_MM_01'  modulename = 'M'  is_active = 'X' workload_score = 2 )
      ( developer_id = 'DEV_MM_02'  modulename = 'M'  is_active = 'X' workload_score = 5 )
      ...
      ( developer_id = 'DEV_PP_01'  modulename = 'P'  is_active = 'X' workload_score = 2 )
