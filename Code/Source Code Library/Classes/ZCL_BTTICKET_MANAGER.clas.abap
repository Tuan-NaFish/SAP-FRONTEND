...
CLASS zcl_btticket_manager IMPLEMENTATION.
  ...
  METHOD create_issue.
    " Authorization: DISABLED per team decision — all users can create tickets
    " check_authorization(
    "   iv_action        = 'CREATE'
  ...
  METHOD assign_issue.
    " Authorization: DISABLED per team decision — all users can reassign
    " check_authorization(
    "   iv_action        = 'UPDATE'
  ...
  METHOD start_progress.
    " Authorization: DISABLED per team decision
    " check_authorization(
    "   iv_action        = 'UPDATE'
    ...
    " Ownership check DISABLED per team decision — any demo user can start progress
  ...
  METHOD resolve_issue.
    ...
    " Ownership check DISABLED per team decision — any demo user can resolve
    " IF ls_issue-assigned_to <> sy-uname.
    "   RAISE EXCEPTION TYPE zcx_btticket_error.
    " ENDIF.
